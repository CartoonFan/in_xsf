...
public:
    ...
    wstring_convert(const byte_string &__byte_err,
        ...
        : __byte_err_string_(__byte_err), __wide_err_string_(__wide_err),
          __cvtptr_(new _Codecvt), __cvtstate_(), __cvtcount_(0) {}
    wstring_convert(wstring_convert &&__wc)
        : __byte_err_string_(move(__wc.__byte_err_string_)),
          __wide_err_string_(move(__wc.__wide_err_string_)),
          __cvtptr_(__wc.__cvtptr_), __cvtstate_(__wc.__cvtstate_),
          __cvtcount_(__wc.__cvtstate_) {
    ...
    wide_string from_bytes(const char *__frm, const char *__frm_end) {
        ...
        if (this->__cvtptr_) {
            ...
            if (__frm != __frm_end) {
                ...
                do {
                    _Elem *__to_nxt;
                    __r = this->__cvtptr_->in(__st, __frm, __frm_end, __frm_nxt, __to,
                                              __to_end, __to_nxt);
                    ...
                    if (__frm_nxt == __frm)
                        ...
                        __ws.append(reinterpret_cast<const _Elem *>(__frm),
                                    reinterpret_cast<const _Elem *>(__frm_end));
                        __frm = __frm_nxt;
                        __r = codecvt_base::ok;
    ...
    byte_string to_bytes(const _Elem *__frm, const _Elem *__frm_end) {
        ...
        if (this->__cvtptr_) {
            ...
            if (__frm != __frm_end) {
                ...
                do {
                    char *__to_nxt;
                    __r = this->__cvtptr_->out(__st, __frm, __frm_end, __frm_nxt, __to,
                                               __to_end, __to_nxt);
                    this->__cvtcount_ += __frm_nxt - __frm;
                    if (__frm_nxt == __frm)
                        __r = codecvt_base::error;
                        ...
                        // This only gets executed if _Elem is char
                        __bs.append(reinterpret_cast<const char *>(__frm),
                                    reinterpret_cast<const char *>(__frm_end));
                        __frm = __frm_nxt;
                        __r = codecvt_base::ok;
                    } else if (__r == codecvt_base::ok) {
