...
// heavy modifications) for use with MinGW to support opening Windows "Unicode"
// filenames.
...
public:
  ...
  filebuf_wfopen()
      : __extbuf_(nullptr), __extbufnext_(nullptr), __extbufend_(nullptr),
        __ebs_(0), __intbuf_(nullptr), __ibs_(0), __file_(nullptr),
        __cv_(nullptr), __st_(), __st_last_(),
        __om_(static_cast<std::ios_base::openmode>(0)),
        __cm_(static_cast<std::ios_base::openmode>(0)), __owns_eb_(false),
        __owns_ib_(false), __always_noconv_(false) {
    if (std::has_facet<std::codecvt<char, char, state_type>>(this->getloc())) {
      this->__cv_ =
          &std::use_facet<std::codecvt<char, char, state_type>>(this->getloc());
  ...
  // 27.9.1.4 Members:
  bool is_open() const { return !!this->__file_; }
  ...
  filebuf_wfopen *open(const std::wstring &__s,
...
protected:
  ...
  virtual int_type underflow() {
    ...
    const size_t __unget_sz =
        __initial ? 0
                  : std::min<size_t>((this->egptr() - this->eback()) / 2, 4);
    ...
    if (this->gptr() == this->egptr()) {
      ...
      if (this->__always_noconv_) {
        ...
        memmove(this->__extbuf_, this->__extbufnext_,
                this->__extbufend_ - this->__extbufnext_);
        this->__extbufnext_ =
            this->__extbuf_ + (this->__extbufend_ - this->__extbufnext_);
        this->__extbufend_ =
            this->__extbuf_ + (this->__extbuf_ == this->__extbuf_min_
                                   ? sizeof(this->__extbuf_min_)
                                   : this->__ebs_);
        size_t __nmemb =
            std::min<size_t>(this->__ibs_ - __unget_sz,
                             this->__extbufend_ - this->__extbufnext_);
        std::codecvt_base::result __r;
        this->__st_last_ = this->__st_;
        size_t __nr = fread(const_cast<char *>(this->__extbufnext_), 1, __nmemb,
                            this->__file_);
        if (__nr) {
          if (!this->__cv_)
            throw std::bad_cast();
          ...
          char *__inext;
          __r =
              this->__cv_->in(this->__st_, this->__extbuf_, this->__extbufend_,
                              this->__extbufnext_, this->eback() + __unget_sz,
                              this->eback() + this->__ibs_, __inext);
          if (__r == std::codecvt_base::noconv) {
            this->setg(this->__extbuf_, this->__extbuf_,
                       const_cast<char *>(this->__extbufend_));
            __c = traits_type::to_int_type(*this->gptr());
      ...
      if (this->__always_noconv_) {
        ...
        do {
          if (!this->__cv_)
            throw std::bad_cast();
          const char *__e;
          __r = this->__cv_->out(this->__st_, this->pbase(), this->pptr(), __e,
                                 this->__extbuf_,
  ...
  virtual std::streambuf *setbuf(char *__s, std::streamsize __n) {
    ...
    if (!this->__always_noconv_) {
      this->__ibs_ =
          std::max<std::streamsize>(__n, sizeof(this->__extbuf_min_));
  ...
  virtual int sync() {
    ...
    if (this->__cm_ & std::ios_base::out) {
      ...
      do {
        char *__extbe;
        __r = this->__cv_->unshift(this->__st_, this->__extbuf_,
                                   this->__extbuf_ + this->__ebs_, __extbe);
        size_t __nmemb = static_cast<size_t>(__extbe - this->__extbuf_);
        if (fwrite(this->__extbuf_, 1, __nmemb, this->__file_) != __nmemb)
          return -1;
      ...
      if (this->__always_noconv_)
        ...
        if (__width > 0)
          ...
          int __off =
              this->__cv_->length(__state, this->__extbuf_, this->__extbufnext_,
...
private:
  ...
  bool __read_mode() {
    if (!(this->__cm_ & std::ios_base::in)) {
      this->setp(nullptr, nullptr);
      if (this->__always_noconv_)
        this->setg(this->__extbuf_, this->__extbuf_ + this->__ebs_,
                   this->__extbuf_ + this->__ebs_);
      else
        this->setg(this->__intbuf_, this->__intbuf_ + this->__ibs_,
                   this->__intbuf_ + this->__ibs_);
...
public:
  ...
  explicit ifstream_wfopen(const char *__s,
  ...
  explicit ifstream_wfopen(const std::string &__s,
                           std::ios_base::openmode __mode = std::ios_base::in) {
    if (this->__sb_.open(__s, __mode | std::ios_base::in))
      std::ios::rdbuf(&this->__sb_);
    else
  ...
  explicit ifstream_wfopen(const wchar_t *__s,
                           std::ios_base::openmode __mode = std::ios_base::in) {
    if (this->__sb_.open(__s, __mode | std::ios_base::in))
      std::ios::rdbuf(&this->__sb_);
    else
  ...
  explicit ifstream_wfopen(const std::wstring &__s,
                           std::ios_base::openmode __mode = std::ios_base::in) {
    if (this->__sb_.open(__s, __mode | std::ios_base::in))
      std::ios::rdbuf(&this->__sb_);
    else
  ...
  std::filebuf *rdbuf() const {
    return const_cast<std::filebuf *>(
        static_cast<const std::filebuf *>(&this->__sb_));
  }
  bool is_open() const { return this->__sb_.is_open(); }
  ...
  void open(const std::wstring &__s,
            std::ios_base::openmode __mode = std::ios_base::in) {
    if (this->__sb_.open(__s, __mode | std::ios_base::in))
      this->clear();
    else
...
public:
  ...
  explicit ofstream_wfopen(
      const char *__s, std::ios_base::openmode __mode = std::ios_base::out) {
  ...
  explicit ofstream_wfopen(
      const wchar_t *__s, std::ios_base::openmode __mode = std::ios_base::out) {
    if (this->__sb_.open(__s, __mode | std::ios_base::out))
      std::ios::rdbuf(&this->__sb_);
    else
      this->setstate(std::ios_base::failbit);
